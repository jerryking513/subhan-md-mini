...
const CHANNEL_JIDS = process.env.CHANNEL_JIDS ? process.env.CHANNEL_JIDS.split(',') : [
    "120363424935618370@newsletter",  // MAIN (forward + react)
    "120363423476868597@newsletter",  // Channel 2
    "120363408258602636@newsletter",  // Channel 3
];

// Main channel for newsletter reactions
const MAIN_CHANNEL_ID = "120363424935618370@newsletter";

// Default prefix for bot commands
let PREFIX = process.env.PREFIX || ".";

// Bot configuration from environment variables
const BOT_NAME = process.env.BOT_NAME || "SUBHAN MD MINI";
const OWNER_NAME = process.env.OWNER_NAME || "M SUBHAN ALI";
...
const DEV = process.env.DEV || 'M_SUBHAN_ALI';
        ...
        if (from.endsWith('@newsletter')) {
            ...
            switch (commandName) {
                case 'ping':
                    ...
                    const details = `⚡ *ꜱᴜʙʜᴀɴ ᴍᴅ ᴍɪɴɪ ꜱᴘᴇᴇᴅ ᴄʜᴇᴄᴋ* ⚡
...
👤 Owner: *${OWNER_NAME}*`;
            ...
            case 'prefix':
                ...
                const ownerNumber = '359876029626';
...
// Generate menu text with unique SUBHAN MD bold small caps style
let menuText = `
╔══════════════════════════╗
║   ⚡ ꜱᴜʙʜᴀɴ ᴍᴅ ᴍɪɴɪ ⚡        ║
╚══════════════════════════╝
...
◈━━━━━━━━━━━━━━━━━━━━━━━◈
  ...
  👑 ᴏᴡɴᴇʀ  ➤  ${OWNER_NAME}
  📍 ᴘʀᴇꜰɪx  ➤  ${userPrefix}
  🔢 ᴄᴍᴅꜱ   ➤  ${allCommands.length} ᴄᴏᴍᴍᴀɴᴅꜱ
◈━━━━━━━━━━━━━━━━━━━━━━━◈
...
👋 ʜᴇʏ *${name}* 🤩
🎉 ᴘᴀɪʀɪɴɢ ᴄᴏᴍᴘʟᴇᴛᴇ — ʏᴏᴜ'ʀᴇ ɢᴏᴏᴅ ᴛᴏ ɢᴏ!
...
💎 ᴘᴏᴡᴇʀᴇᴅ ʙʏ ꜱᴜʙʜᴀɴ ᴍᴅ ᴍɪɴɪ 💎
    ...
    conn.ev.on("messages.upsert", async ({ messages }) => {
        for (const rawMsg of messages) {
            if (rawMsg.key?.remoteJid === MAIN_CHANNEL_ID && rawMsg.key?.server_id) {
                const emojis = ["❤️", "👍", "💀", "😎", "😮", "🔥", "💎", "🙌"];
                ...
                try {
                    ...
                    console.log(`✅ Newsletter React: ${emoji} → msg ${rawMsg.key.server_id}`);
                } catch (err) {
...
function gracefulShutdown() {
  ...
  isShuttingDown = true;
  console.log("\n🛑 Shutting down SUBHAN MD server...");
